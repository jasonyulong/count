...
// 数据库配置
$database = include dirname(__DIR__) . '/config/database.' . ENVIRONMENT . '.php';
...
return [
    ...
    // | redis配置
    // +----------------------------------------------------------------------
    'redis'                  => include dirname(__DIR__) . '/config/redis.' . ENVIRONMENT . '.php',
    ...
    'session'                => [
        ...
        'var_session_id' => '',
        // SESSION 域名
        'domain'         => Env::get('app.debug') ? 'test.com' : 'spocoo.com',
        // SESSION 前缀
        'prefix'         => 'think',
    ...
    'token'                  => array_merge([
        ...
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
    ], include dirname(__DIR__) . '/config/redis.' . ENVIRONMENT . '.php'),
    //erp配置
    'erp'                    => [
        //是否开启前台会员中心
        'usercenter'          => true,
