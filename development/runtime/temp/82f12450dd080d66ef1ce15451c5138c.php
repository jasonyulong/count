<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/opt/web/count/development/public/../application/common/view/tpl/dispatch_jump.tpl";i:1550824651;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="system-message <?php echo $codeText; ?>">
    ...
    <?php endif; ?>
    <p class="clearfix">
        <a href="/count" class="btn btn-grey"><?php echo __('Go back'); ?></a>
        <?php if($url): ?>
