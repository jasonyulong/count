<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:87:"/opt/web/count/development/public/../application/count/view/develop/saleroom/index.html";i:1551349980;s:69:"/opt/web/count/development/application/count/view/layout/default.html";i:1544600061;s:66:"/opt/web/count/development/application/count/view/common/meta.html";i:1550824652;s:68:"/opt/web/count/development/application/count/view/common/header.html";i:1550824652;s:77:"/opt/web/count/development/application/count/view/develop/saleroom/table.html";i:1551411682;s:68:"/opt/web/count/development/application/count/view/common/script.html";i:1550824652;s:69:"/opt/web/count/development/application/count/view/layout/btn_top.html";i:1550824653;}*/ ?>
<!DOCTYPE html>
...
<aside class="main-sidebar">
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li class="<?php echo $type=='date'?'active' : ''; ?>"><a href="<?php echo url('/count/develop/saleroom', ['type' => 'date']); ?>">按日期</a></li>
            <li class="pull-right">
                <div class="btn-toolbar" role="toolbar">
                    <div class="btn-group padding-top8 paddint-right5">
                        <a href="<?php echo url('/count/develop/saleroom', array_merge($params, ['type' => $type, 'model' => 'table'])); ?>" data-toggle="tooltip"
                           class="btn btn-xs btn-default <?php echo $model=='table'?'active' : ''; ?>"
                           title="列表模式"><span class="fa fa-fw fa-th-large"></span></a>
                        <a href="<?php echo url('/count/develop/saleroom', array_merge($params,['type' => $type, 'model' => 'chart'])); ?>" data-toggle="tooltip"
        ...
        <div class="box-body">
            <div class="box box-solid">
                <div class="box-header with-border">
                    <form action="<?php echo url('/count/develop/saleroom', array_merge($params,['type' => $type, 'model' => $model]), ''); ?>" method="get" class="form-inline froms clearfix">
    ...
    <i class="icon fa fa-warning"></i> 说明：币种(美元)
</div>
<table class="table table-bordered table-hover dataTable display nowrap compact table-striped js-table">
    ...
    <tr>
        ...
        <?php endif; if(is_numeric($key)): if($params['checkDate'] == 'month'): ?>
                <th class="text-center">
                    <span class="block" data-toggle="tooltip" data-placement="bottom"  title="111">
                    <?php echo date('Y-m',strtotime($key.'01')); ?>
                     </span>
                </th>
            <?php else: ?>
                <span class="block" data-toggle="tooltip" data-placement="bottom"  title="111">
    ...
    <tr>
        <td class="text-center"><?php echo $key; ?></td>
            <?php if(is_array($total) || $total instanceof \think\Collection || $total instanceof \think\Paginator): $i = 0; $__LIST__ = $total;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($key == 'month'): ?><td class="text-center">
                    <span class="block" data-toggle="tooltip" data-placement="bottom"  title="退款金额:<?php echo $vo[$key]['refunds']; ?>,退货金额:<?php echo $vo[$key]['return_total']; ?>">
                        <?php echo $vo[$key]['sales']; ?>
                    </span>
                </td><?php endif; if(is_numeric($key)): ?><td class="text-center">
                    <span class="block" data-toggle="tooltip" data-placement="bottom"  title="退款金额:<?php echo $vo[$key]['refunds']; ?>,退货金额:<?php echo $vo[$key]['return_total']; ?>">
                    <?php echo $vo[$key]['sales']; ?>
                    </span>
                    </td>
