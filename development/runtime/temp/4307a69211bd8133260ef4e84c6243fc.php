<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:80:"/opt/web/count/development/public/../application/count/view/auth/rule/index.html";i:1547190894;s:69:"/opt/web/count/development/application/count/view/layout/default.html";i:1544600061;s:70:"/opt/web/count/development/application/count/view/layout/default2.html";i:1547190894;s:66:"/opt/web/count/development/application/count/view/common/meta.html";i:1544600061;s:68:"/opt/web/count/development/application/count/view/common/header.html";i:1548384832;s:65:"/opt/web/count/development/application/count/view/common/map.html";i:1547190894;s:68:"/opt/web/count/development/application/count/view/common/script.html";i:1548747211;s:69:"/opt/web/count/development/application/count/view/layout/btn_top.html";i:1544600061;}*/ ?>
<!DOCTYPE html>
    ...
    <section class="content">
        <div class="box box-default color-palette-box">
            <div class="box-header with-border">
                ...
                <button type="button" class="btn bg-primary btn-sm btn-dialog" href="<?php echo url('/count/auth/rule/add'); ?>" title="<?php echo __('添加菜单'); ?>"><i
                        class="fa fa-plus-circle"></i> <?php echo __('添加菜单'); ?>
                </button>
                <?php endif; ?>
                <!--<button type="button" class="btn bg-orange btn-sm btn-ajax" href="<?php echo url('/count/auth/rule/clear'); ?>"><i class="fa fa-fw fa-spinner"></i><?php echo __('更新缓存'); ?></button>-->
            </div>
            ...
            <div class="box-body">
                <table id="table" class="table table-bordered table-hover" width="100%">
                    ...
                    <tbody>
                    <?php foreach($rulelist as $val): if($val['ismenu'] == 1): ?>
                    <tr>
                        <td class="text-center"><?php echo $val['id']; ?></td>
                        <td><?php echo $val['title']; ?></td>
                        <td><span><i class="<?php echo $val['icon']; ?>"></i></span></td>
                        <td><?php echo $val['name']; ?></td>
                        <td class="text-center"><?php echo $val['weigh']; ?></td>
                        <td>
                            <?php if($val['status'] == 1): ?>
                        ...
                        <td class="text-center">
                            <button type="button"
                                    ...
                                    title="<?php echo __('查看权限节点'); ?>"
                                    options="{area:['900px','700px']}"
                                    href="<?php echo url('/count/auth/rule/actions', [$val['id']]); ?>"><i class="fa fa-sitemap"></i>
                            </button>
                            <?php if($auth->check('count/auth/rule/edit')): ?>
                            <button type="button"
                                    class="btn btn-success btn-edit btn-dialog btn-xs"
                                    title="<?php echo __('编辑'); ?>"
                                    href="<?php echo url('/count/auth/rule/edit', [$val['id']]); ?>"><i class="fa fa-pencil"></i>
                            </button>
