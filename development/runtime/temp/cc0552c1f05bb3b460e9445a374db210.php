<?php if (!defined('THINK_PATH')) exit(); /*a:14:{s:81:"/opt/web/count/development/public/../application/count/view/order/sale/index.html";i:1544600061;s:69:"/opt/web/count/development/application/count/view/layout/default.html";i:1544600061;s:73:"/opt/web/count/development/application/count/view/order/sale/_layout.html";i:1551349980;s:66:"/opt/web/count/development/application/count/view/common/meta.html";i:1550824652;s:68:"/opt/web/count/development/application/count/view/common/header.html";i:1550824652;s:75:"/opt/web/count/development/application/count/view/order/sale/_tabs_bar.html";i:1548747211;s:71:"/opt/web/count/development/application/count/view/order/sale/_form.html";i:1552989433;s:76:"/opt/web/count/development/application/count/view/order/sale/table_date.html";i:1551349980;s:77:"/opt/web/count/development/application/count/view/order/sale/table_organ.html";i:1552989433;s:78:"/opt/web/count/development/application/count/view/order/sale/table_seller.html";i:1552989433;s:71:"/opt/web/count/development/application/count/view/order/sale/table.html";i:1552989433;s:71:"/opt/web/count/development/application/count/view/order/sale/chart.html";i:1544600061;s:68:"/opt/web/count/development/application/count/view/common/script.html";i:1550824652;s:69:"/opt/web/count/development/application/count/view/layout/btn_top.html";i:1550824653;}*/ ?>
<!DOCTYPE html>
...
<aside class="main-sidebar">
    ...
    <li class="<?php echo $type=='date'?'active' : ''; ?>"><a href="<?php echo url('/count/order/Sale', ['type' => 'date']); ?>">按日期</a></li>
    <li class="<?php echo $type=='platform'?'active' : ''; ?>"><a href="<?php echo url('/count/order/Sale', ['type' => 'platform']); ?>">按平台</a></li>
    <?php if($is_top_manager): ?>
    <li class="<?php echo $type=='organ'?'active' : ''; ?>"><a href="<?php echo url('/count/order/Sale', ['type' => 'organ']); ?>">按组织架构</a></li>
    <?php endif; ?>
    <li class="<?php echo $type=='seller'?'active' : ''; ?>"><a href="<?php echo url('/count/order/Sale', ['type' => 'seller']); ?>">按销售员</a></li>
    <li class="<?php echo $type=='account'?'active' : ''; ?>"><a href="<?php echo url('/count/order/Sale', ['type' => 'account']); ?>">按账号</a></li>
    <li class="<?php echo $type=='store'?'active' : ''; ?>"><a href="<?php echo url('/count/order/Sale', ['type' => 'store']); ?>">按仓库</a></li>
    <li class="<?php echo $type=='location'?'active' : ''; ?>"><a href="<?php echo url('/count/order/Sale', ['type' => 'location']); ?>">按Location</a></li>
    <li class="pull-right">
        <div class="btn-toolbar" role="toolbar">
            <div class="btn-group padding-top8 paddint-right5">
                <?php if($params['type'] != 'organ'): ?>
                <a href="<?php echo url('/count/order/Sale', array_merge($params, ['type' => $type, 'model' => 'table'])); ?>" data-toggle="tooltip" class="btn btn-xs btn-default <?php echo $model=='table'?'active' : ''; ?>"
                   title="列表模式"><span class="fa fa-fw fa-th-large"></span></a>

                <a href="<?php echo url('/count/order/Sale', array_merge($params,['type' => $type, 'model' => 'chart'])); ?>" data-toggle="tooltip" class="btn btn-xs btn-default <?php echo $model=='chart'?'active' : ''; ?>" title="图表模式"><span class="fa fa-fw fa-bar-chart-o"></span></a>
                <?php endif; ?>
            </div>
        </div>
    </li>
                ...
                <div class="box-body">
                    <div class="box box-solid">
                        <div class="box-header with-bsales">
                            <form action="<?php echo url('/count/order/Sale', array_merge($params,['type' => $type, 'model' => $model])); ?>" method="get" class="form-inline froms clearfix">
    ...
    <div class="form-group" style="float: right;">
        <?php if($auth->check('count/order/sale/organTrendency')): ?>
        ...
        &nbsp;<?php endif; if($auth->check('count/order/sale/setTarget')): ?>
...
<table class="table table-bordered table-hover dataTable table-striped display nowrap compact js-table">
    ...
    <tr>
        ...
        <?php endif; if($params['checkDate'] == 'day'): ?>
    ...
    <tr>
        ...
        <th class="text-center">销售单量 <a href="javascript:void(0);" data-container='body' data-toggle="tooltip" data-placement="" title="销售单量=排除掉回收站和补发的订单数"><i class="fa fa-fw fa-question-circle"></i></a></th>
        <?php if($params['type'] == 'date'): ?>
        <th class="text-center">单量增幅 <a href="javascript:void(0);" data-container='body' data-toggle="tooltip" data-placement="" title="单量增幅=相对于前一天的单量增幅%比"><i class="fa fa-fw fa-question-circle"></i></a></th>
        <?php endif; ?>
        <th class="text-center">销售额 ($) <a href="javascript:void(0);" data-container='body' data-toggle="tooltip" data-placement="" title="销售额=排除掉回收站和补发的订单销售额"><i class="fa fa-fw fa-question-circle"></i></a></th>
        <?php if($params['type'] == 'date'): ?>
        <th class="text-center">销售额增幅 <a href="javascript:void(0);" data-container='body' data-toggle="tooltip" data-placement="" title="销售额增幅=相对于前一天的销售额增幅%比"><i class="fa fa-fw fa-question-circle"></i></a></th>
        <?php endif; if($params['checkDate'] == 'day'): ?>
        <th class="text-center">上周同期销售额($)</th>
        <?php endif; ?>
        <th class="text-center">上月同期销售额($)</th>
        <th class="text-center">相对于平均</th>
    </tr>
    </thead>
    ...
    <tr>
        <td class="text-center">
            ...
            <?php echo $item['platform']; elseif($params['type'] == 'account'): ?>
            <?php echo $item['platform_account']; else: if($params['checkDate'] == 'day'): ?>
            <?php echo $item['year']; ?>-<?php echo $item['month']; ?>-<?php echo $item['days']; else: ?>
            <?php echo $item['year']; ?>-<?php echo $item['month']; endif; endif; ?>
        </td>
        <td class="text-center"><?php echo $item['sum_totals']; ?></td>
        <?php if($params['type'] == 'date'): ?>
        <td class="text-center" <?php if($item['total_percent'] > 0): ?>style="color:red;"<?php else: ?>style="color:green;"<?php endif; ?>><?php echo $item['total_percent']; ?></td>
        <?php endif; ?>
        <td class="text-center"><?php echo $item['sum_sales']; ?></td>
        <?php if($params['type'] == 'date'): ?>
        <td class="text-center" <?php if($item['sum_percent'] > 0): ?>style="color:red;"<?php else: ?>style="color:green;"<?php endif; ?>><?php echo $item['sum_percent']; ?></td>
        <?php endif; if($params['checkDate'] == 'day'): ?>
        <td class="text-center"><?php echo $item['week_increment']; ?></td>
        <?php endif; ?>
        <td class="text-center"><?php echo $item['month_sales_increment']; ?></td>
        <td class="text-center" <?php if(($item['average_percent'] ?? 0) > 0): ?>style="color:red;"<?php else: ?>style="color:green;"<?php endif; ?>><?php echo isset($item['average_percent'])?$item['average_percent']: 0; ?></td>
    </tr>
    <?php endforeach; ?>
    </tbody>
</table>
...
<table class="table table-bordered table-hover dataTable display nowrap compact js-table" id="scroll_table"  style="width: 100%;">
    ...
    <tr>
        <td class="text-center table-total">合计</td>
        <td class="text-center table-total"></td>
        <?php if($params['type'] == 'organ' || $params['type'] == 'seller'): foreach($months as $m): ?>
        <td class="text-center table-total"></td>
        ...
        <td class="text-center table-total">
            <span class="cursor" data-container='body' data-toggle="tooltip"  data-placement="left" title="单量:<?php echo $total_data[$v]['sum_totals']; ?>&nbsp;&nbsp;客单价:<?php echo getRound($total_data[$v]['sum_sales'], $total_data[$v]['sum_totals']); ?>"><?php echo $total_data[$v]['sum_sales']; ?></span>
        </td>
        <?php endforeach; ?>
    ...
    <tr>
        ...
        <?php if($params['type'] == 'organ' || $params['type'] == 'seller'): foreach($months as $m): if(date('Y-m') == $m): ?>
        <th class="text-center">当月平均</th>
        <?php else: ?>
        <th class="text-center"><?php echo explode('-', $m)[1]; ?>月平均</th>
    ...
    <tr class="<?php if($item['level']==2): ?>warning<?php endif; if($item['level'] == 3 && count($item['full_child_ids']) != 1): ?>shallow_warning<?php endif; ?>">
        <td class="text-left">
            <?php if($item['level'] > 2): ?>
            |<?php echo str_repeat('---', ($item['level'] - 1)); endif; ?>
            <?php echo $item['organ_name']; ?>
        </td>
        <td class="text-center">
            <?php echo $item['username']; ?>
        </td>

        <?php if($params['type'] == 'organ' || $params['type'] == 'seller'): foreach($item['monthly_data'] as $m_k => $m): ?>
        <td class="text-center">
            <span class="cursor" data-container='body' data-toggle="tooltip"  data-placement="left"  title="月售额：<?php echo $m['sales']; ?> 月目标：<?php echo isset($target_map[$item['id'] .'-'.$m_k])?$target_map[$item['id'] .'-'.$m_k]: 0; ?> 达标率：<?php if(isset($target_map[$item['id'] .'-'.$m_k]) && $target_map[$item['id'] .'-'.$m_k] != 0): ?><?php echo round($m['sales'] / $target_map[$item['id'] .'-'.$m_k],4) * 100; ?>%<?php else: ?>-<?php endif; ?>">
                <?php echo $m['month_avg']; ?>
            </span>
        </td>
        <?php endforeach; endif; ?>
        <!--<td class="text-center">-->
            <!--<span class="block" data-container='body' data-toggle="tooltip"  title="单量：<?php echo $item['average_totals']; ?>"><?php echo $item['average_sales']; ?></span>-->
        <!--</td>-->

        <td class="text-center table-total">
            <span class="cursor" data-container='body' data-toggle="tooltip"  data-placement="left"  title="单量:<?php echo $item['all_total']; ?>&nbsp;&nbsp;客单价:<?php echo getRound($item['all_sums'], $item['all_total']); ?>"><?php echo $item['all_sums']; ?></span>
        </td>
        
        <?php foreach($item['dates'] as $k => $sub_item): ?>
        <td class="text-center">
            <span class="cursor" data-container='body' data-toggle="tooltip"  data-placement="left" title="单量:<?php echo $sub_item['sum_totals']; ?>&nbsp;&nbsp;客单价:<?php echo getRound($sub_item['sum_sales'], $sub_item['sum_totals']); ?>"><?php echo $sub_item['sum_sales']; ?></span>
        </td>
        <?php endforeach; ?>
    </tr>
    <?php endforeach; ?>
...
<table class="table table-bordered table-hover  table-striped display nowrap compact js-table " id="scroll_table" style="width:100%">
    <thead>

    <?php if($params['type'] == 'seller'  && !empty($total_data)): ?>
    <!--合计-->
    <tr>
        <td class="text-center table-total">合计</td>
        <td class="text-center table-total"></td>
        ...
        <?php foreach($range as $v): ?>
        <td class="text-center table-total">
            <span class="cursor" data-container='body' data-toggle="tooltip"  data-placement="left"  title="单量:<?php echo $total_data[$v]['sum_totals']; ?>&nbsp;&nbsp;客单价:<?php echo getRound($total_data[$v]['sum_sales'], $total_data[$v]['sum_totals']); ?>">
                    <?php echo isset($total_data[$v]['sum_sales'])?$total_data[$v]['sum_sales']: 0; ?>
            </span>
            </td>
        <?php endforeach; ?>
    ...
    <tr>
        ...
        <!--<th class="text-center">当前平均</th>-->
        <th class="text-center table-total">当前合计</th>
    ...
    <tr>
        ...
        <td class="text-left"><?php echo (isset($item['dates'][$params['scantime_end']]['org_parent_name']) && ($item['dates'][$params['scantime_end']]['org_parent_name'] !== '')?$item['dates'][$params['scantime_end']]['org_parent_name']:'-'); ?>
        <span class="text-danger"><?php echo (isset($item['dates'][$params['scantime_end']]['org_name']) && ($item['dates'][$params['scantime_end']]['org_name'] !== '')?$item['dates'][$params['scantime_end']]['org_name']:'-'); ?></span>
        </td>
        <?php endif; if($params['type'] == 'seller' && $params['checkDate'] == 'month'): ?>
        <td class="text-left"><?php echo (isset($item['dates'][$params['scandate_end']]['org_parent_name']) && ($item['dates'][$params['scandate_end']]['org_parent_name'] !== '')?$item['dates'][$params['scandate_end']]['org_parent_name']:'-'); ?>
        <span class="text-danger"><?php echo (isset($item['dates'][$params['scandate_end']]['org_name']) && ($item['dates'][$params['scandate_end']]['org_name'] !== '')?$item['dates'][$params['scandate_end']]['org_name']:'-'); ?></span>
        </td>
        <?php endif; ?>
        <td class="text-center">
            <?php if($params['type'] == 'seller'): ?>
        ...
        <td class="text-center">
            <span class="cursor" data-container='body' data-toggle="tooltip"  data-placement="left"  title="当月目标:<?php echo $item['monthly_data'][date('Y-m')]['target_value']; ?>">
                <?php echo $item['monthly_data'][date('Y-m')]['target_achive']; ?>
            </span>
        </td>

        <?php if($params['type'] == 'organ' || $params['type'] == 'seller'): foreach($item['monthly_data'] as $m_k => $m): ?>
        <td class="text-center">
            <span class="cursor" data-container='body' data-toggle="tooltip"  data-placement="left"  title="月售额：<?php echo $m['sales']; ?> 月目标:<?php echo $m['target_value']; ?> 月达标率：<?php echo $m['target_achive']; ?>">
                <?php echo $m['month_avg']; ?>
            </span>
        </td>
        <?php endforeach; endif; ?>
        ...
        <!--<td class="text-center">-->
            <!--<span class="block" data-container='body' data-toggle="tooltip"  title="单量：<?php echo $date_aver_map[$key]['average_totals']; ?>">-->
            <!--<?php echo $date_aver_map[$key]['average_sales']; ?>-->
            <!--</span>-->
        <!--</td>-->
        <td class="text-center table-total">
            <span class="cursor" data-container='body' data-toggle="tooltip"  data-placement="left"  title="单量:<?php echo $date_total_map[$key]['sum_totals']; ?>&nbsp;&nbsp;客单价:<?php echo getRound($date_total_map[$key]['sum_sales'], $date_total_map[$key]['sum_totals']); ?>">
            <?php echo $date_total_map[$key]['sum_sales']; ?>
            </span>
        </td>

        <?php foreach($item['dates'] as $k => $sub_item): ?>
        <td class="text-center">
            <span class="cursor" data-container='body' data-toggle="tooltip"  data-placement="left" title="单量:<?php echo $sub_item['sum_totals']; ?>&nbsp;&nbsp;客单价:<?php echo getRound($sub_item['sum_sales'], $sub_item['sum_totals']); ?>">
            <?php echo $sub_item['sum_sales']; ?>
            </span>
        </td>
        <?php endforeach; ?>
...
<table class="table table-bordered table-hover dataTable table-striped display nowrap compact <?php if($params['type'] != 'seller'): ?>js-table<?php endif; ?>" id="scroll_table" style="width: 100%;">
    <thead>
    ...
    <tr>
        ...
        <?php foreach($range as $v): ?>
        <td class="text-center table-total">
            <span class="cursor" data-container='body' data-toggle="tooltip"  data-placement="left" title="单量:<?php echo isset($total_data[$v]['sum_totals'])?$total_data[$v]['sum_totals']: 0; ?>&nbsp;&nbsp;客单价:<?php echo getRound($total_data[$v]['sum_sales'], $total_data[$v]['sum_totals']); ?>">
                    <?php echo isset($total_data[$v]['sum_sales'])?$total_data[$v]['sum_sales']: 0; ?>
            </span>
            </td>
        <?php endforeach; ?>
    ...
    <tr>
        <th class="text-center">
            <?php if($params['type'] == 'platform'): ?>
            平台
            <?php elseif($params['type'] == 'store'): ?>
            仓库
            <?php elseif($params['type'] == 'location'): ?>
            Location
            <?php else: ?>
            账号
            <?php endif; ?>
        ...
        <?php if($params['type'] == 'account'): ?>
        <th class="text-center">当月达标率</th>
        <?php foreach($months as $m): if(date('Y-m') == $m): ?>
        <th class="text-center">当月平均</th>
        <?php else: ?>
        <th class="text-center"><?php echo explode('-', $m)[1]; ?>月平均</th>
        <?php endif; endforeach; endif; ?>
    ...
    <tr>
        <td class="text-center">
            <?php if($params['type'] == 'store'): if(isset($all_stores[$key]['store_name'])): ?>
                    <?php echo $all_stores[$key]['store_name']; else: ?>
                    <?php echo $key; endif; else: ?><?php echo $key; endif; ?>
        </td>
        ...
        <?php foreach($item['monthly_data'] as $m_k => $m): ?>
        <td class="text-center">
            <span class="cursor" data-container='body' data-toggle="tooltip"  data-placement="left"  title="月售额：<?php echo $m['sales']; ?> 月目标:<?php echo $m['target_value']; ?> 月达标率：<?php echo $m['target_achive']; ?>">
                <?php echo $m['month_avg']; ?>
            </span>
        ...
        <td class="text-center">
            <span class="cursor" data-container='body' data-toggle="tooltip"  data-placement="left"  title="单量：<?php echo $date_aver_map[$key]['average_totals']; ?>">
            <?php echo $date_aver_map[$key]['average_sales']; ?>
            </span>
        </td>
