<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:91:"/opt/web/count/development/public/../application/count/view/order/index/index_platform.html";i:1544600061;s:69:"/opt/web/count/development/application/count/view/layout/default.html";i:1544600061;s:66:"/opt/web/count/development/application/count/view/common/meta.html";i:1544600061;s:68:"/opt/web/count/development/application/count/view/common/header.html";i:1548384832;s:72:"/opt/web/count/development/application/count/view/order/index/table.html";i:1544600061;s:72:"/opt/web/count/development/application/count/view/order/index/chart.html";i:1544600061;s:66:"/opt/web/count/development/application/count/view/layout/page.html";i:1544600061;s:68:"/opt/web/count/development/application/count/view/common/script.html";i:1547190894;s:69:"/opt/web/count/development/application/count/view/layout/btn_top.html";i:1544600061;}*/ ?>
<!DOCTYPE html>
            ...
            <li class="pull-right">
                <div class="btn-toolbar" role="toolbar">
                    <div class="btn-group padding-top8 paddint-right5">
                        <a href="<?php echo url('/count/order/index', array_merge($params, ['type' => $type, 'model' => 'table'])); ?>" data-toggle="tooltip" class="btn btn-xs btn-default <?php echo $model=='table'?'active' : ''; ?>"
                           title="列表模式"><span class="fa fa-fw fa-th-large"></span></a>
                        <a href="<?php echo url('/count/order/index', array_merge($params,['type' => $type, 'model' => 'chart'])); ?>" data-toggle="tooltip" class="btn btn-xs btn-default <?php echo $model=='chart'?'active' : ''; ?>"
                ...
                <div class="box-header with-border">
                    <form action="<?php echo url('/count/order/index', array_merge($params,['type' => $type, 'model' => $model])); ?>" method="get" class="form-inline froms clearfix">
                        ...
                        <div class="form-group">
                            <select class="selectpicker" title="全部平台" name="platform[]" id="platform" data-actions-box="true" data-live-search="true" multiple>
                                <?php foreach($platforms as $item): ?>
                                    <option value="<?php echo $item; ?>" <?php if(in_array($item, $params['platform'] ?? [])): ?>selected<?php endif; ?>><?php echo $item; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group laydate-group">
                                <input type="text" class="input-sm form-control input-date datepicker <?php if($params['checkDate'] != 'day'): ?>hide<?php endif; ?>" name="scantime_start" value="<?php echo $params['scantime_start']; ?>" placeholder="开始时间" readonly>
                                <input type="text" class="input-sm form-control input-date monthpicker <?php if($params['checkDate'] != 'month'): ?>hide<?php endif; ?>" name="scandate_start" value="<?php echo $params['scandate_start']; ?>" placeholder="开始年月" readonly>
...
<table class="table table-bordered table-hover dataTable table-striped js-table">
    ...
    <tr>
        ...
        <th class="text-center">总订单数 <a href="javascript:void(0);" data-toggle="tooltip" title="总订单数=原始订单数+补发订单数+拆分创建订单数+手工订单数+合并后订单数+作废订单数"><i class="fa fa-fw fa-question-circle"></i></a></th>
        <th class="text-center">可发货数 <a href="javascript:void(0);" data-toggle="tooltip" title="可发货数=总订单数-作废订单数"><i class="fa fa-fw fa-question-circle"></i></a></th>
        <th class="text-center">未发货数 <a href="javascript:void(0);" data-toggle="tooltip" title="未发货数=进系统后但是并没有发货(排除了作废订单)"><i class="fa fa-fw fa-question-circle"></i></a></th>
        <th class="text-center">已发货数 <a href="javascript:void(0);" data-toggle="tooltip" title="已发货数=进系统并已发货订单数"><i class="fa fa-fw fa-question-circle"></i></a></th>
        <th class="text-center">已完成数 <a href="javascript:void(0);" data-toggle="tooltip" title="已完成数=进系统并已经确认利润订单数"><i class="fa fa-fw fa-question-circle"></i></a></th>
        <th class="text-center">补发数 <a href="javascript:void(0);" data-toggle="tooltip" title="补发数=手动创建的补发订单数"><i class="fa fa-fw fa-question-circle"></i></a></th>
        <th class="text-center">退款数 <a href="javascript:void(0);" data-toggle="tooltip" title="退款数=获取到已产生退款订单数"><i class="fa fa-fw fa-question-circle"></i></a></th>
        <th class="text-center">退货数 <a href="javascript:void(0);" data-toggle="tooltip" title="退货数=产生退货订单数"><i class="fa fa-fw fa-question-circle"></i></a></th>
        <th class="text-center">手工作废数 <a href="javascript:void(0);" data-toggle="tooltip" title="作废数=手工操作进回收站订单数"><i class="fa fa-fw fa-question-circle"></i></a></th>
        <th class="text-center">系统作废数 <a href="javascript:void(0);" data-toggle="tooltip" title="作废数=系统操作进回收站订单数"><i class="fa fa-fw fa-question-circle"></i></a></th>
        <th class="text-center">仓库发货数 <a href="javascript:void(0);" data-toggle="tooltip" title="仓库发货数=仓库实际发货订单总数"><i class="fa fa-fw fa-question-circle"></i></a></th>
    </tr>
    </thead>
    <tbody>
    ...
    <tr>
        ...
        <td class="text-center">
            <span class="block" data-toggle="tooltip"  title="<?php foreach($item['type_list'] as $value): ?><?php echo $value['type_name']; ?>:<?php echo $value['sum_totals']; ?>&nbsp;&nbsp;<?php endforeach; ?>">
            <?php echo $item['sum_totals']; ?>
            </span>
        </td>
        <td class="text-center"><?php echo $item['sum_can_send']; ?></td>
        <td class="text-center">
            <span class="block" data-toggle="tooltip"  title="<?php foreach($item['type_list'] as $value): ?><?php echo $value['type_name']; ?>:<?php echo $value['sum_noships']; ?>&nbsp;&nbsp;<?php endforeach; ?>">
            <?php echo $item['sum_noships']; ?>
            </span>
        </td>
        <td class="text-center">
            <span class="block" data-toggle="tooltip"  title="<?php foreach($item['type_list'] as $value): ?><?php echo $value['type_name']; ?>:<?php echo $value['sum_ships']; ?>&nbsp;&nbsp;<?php endforeach; ?>">
            <?php echo $item['sum_ships']; ?>
            </span>
        </td>
        <td class="text-center">
            <span class="block" data-toggle="tooltip"  title="<?php foreach($item['type_list'] as $value): ?><?php echo $value['type_name']; ?>:<?php echo $value['sum_overs']; ?>&nbsp;&nbsp;<?php endforeach; ?>">
