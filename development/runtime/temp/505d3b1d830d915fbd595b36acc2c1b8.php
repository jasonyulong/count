<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:81:"/opt/web/count/development/public/../application/count/view/auth/group/index.html";i:1547190894;s:69:"/opt/web/count/development/application/count/view/layout/default.html";i:1544600061;s:70:"/opt/web/count/development/application/count/view/layout/default2.html";i:1547190894;s:66:"/opt/web/count/development/application/count/view/common/meta.html";i:1544600061;s:68:"/opt/web/count/development/application/count/view/common/header.html";i:1548384832;s:65:"/opt/web/count/development/application/count/view/common/map.html";i:1547190894;s:68:"/opt/web/count/development/application/count/view/common/script.html";i:1548747211;s:69:"/opt/web/count/development/application/count/view/layout/btn_top.html";i:1544600061;}*/ ?>
<!DOCTYPE html>
    ...
    <section class="content">
        <div class="box box-default color-palette-box">
            <div class="box-header with-border">
                ...
                <?php if($auth->check('count/auth/group/add')): ?>
                <button type="button" class="btn bg-primary btn-sm btn-dialog"
                        options="{area:['500px','400px']}"
                        href="<?php echo url('/count/auth/group/add'); ?>" title="<?php echo __('添加角色'); ?>"><i class="fa fa-plus-circle"></i> <?php echo __('添加角色'); ?>
                </button>
                <?php endif; ?>
            </div>
                ...
                <table id="table" class="table table-bordered table-hover" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?php if($auth->check('count/auth/group/edit') && $val['rules'] != '*'): ?>
                            <button type="button"
                                    class="btn btn-success btn-edit btn-dialog btn-xs"
                                    title="<?php echo __('编辑'); ?>"
                                    options="{area:['500px','400px']}"
                                    href="<?php echo url('/count/auth/group/edit', [$val['id']]); ?>"><i class="fa fa-pencil"></i> <?php echo __('编辑'); ?>
                            </button>
                            <?php endif; if($auth->check('count/auth/group/roletree') && $val['rules'] != '*'): ?>
                            <button type="button"
                                    class="btn btn-warning btn-edit btn-dialog btn-xs"
                                    title="<?php echo __('权限'); ?>"
                                    options="{area:['1024px','90%']}"
                                    href="<?php echo url('/count/auth/group/roletree', ['id' => $val['id'], 'pid' => $val['pid']]); ?>"><i class="fa fa-paw"></i> <?php echo __('权限'); ?>
                            </button>
                            <?php endif; if($auth->check('count/auth/group/del') && $val['rules'] != '*'): ?>
                            <button type="button"
                                    class="btn btn-danger btn-edit btn-ajax btn-xs"
                                    options="{confirm:'确定要删除此项吗？'}"
                                    title="<?php echo __('删除'); ?>"
                                    href="<?php echo url('/count/auth/group/del', [$val['id']]); ?>"><i class="fa fa-trash"></i> <?php echo __('删除'); ?>
                            </button>
                            <?php endif; ?>
                        </td>
                    </tr>
