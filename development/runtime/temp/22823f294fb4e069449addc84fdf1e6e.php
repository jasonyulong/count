<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:81:"/opt/web/count/development/public/../application/count/view/auth/admin/index.html";i:1548384832;s:69:"/opt/web/count/development/application/count/view/layout/default.html";i:1544600061;s:70:"/opt/web/count/development/application/count/view/layout/default2.html";i:1547190894;s:66:"/opt/web/count/development/application/count/view/common/meta.html";i:1544600061;s:68:"/opt/web/count/development/application/count/view/common/header.html";i:1548384832;s:65:"/opt/web/count/development/application/count/view/common/map.html";i:1547190894;s:68:"/opt/web/count/development/application/count/view/common/script.html";i:1547190894;s:69:"/opt/web/count/development/application/count/view/layout/btn_top.html";i:1544600061;}*/ ?>
<!DOCTYPE html>
    ...
    <section class="content">
        <div class="box box-default color-palette-box">
            <div class="box-header with-border">
                ...
                <?php if($auth->check('count/auth/admin/add')): ?>
                <!--<button type="button" class="btn bg-primary btn-sm btn-dialog"-->
                        <!--href="<?php echo url('/count/auth/admin/add'); ?>" title="<?php echo __('添加管理员'); ?>"><i class="fa fa-plus-circle"></i> <?php echo __('添加管理员'); ?>-->
                <!--</button>-->
                <?php endif; ?>
            </div>
            ...
            <div class="box-body">
                <table id="table" class="table table-bordered table-hover" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($val['groups'] == 1): ?>
                            <span class="text-danger"><?php echo $val['groups_text']; ?></span>
                            <?php else: ?>
                            <?php echo $val['groups_text']; endif; ?>
                        </td>
                        <td><?php echo $val['username']; ?></td>
                        <td><?php echo (isset($val['position']) && ($val['position'] !== '')?$val['position']:'--'); ?></td>
                        <td><?php echo (isset($val['mobile']) && ($val['mobile'] !== '')?$val['mobile']:'--'); ?></td>
                        <td><?php echo (isset($val['email']) && ($val['email'] !== '')?$val['email']:'--'); ?></td>
                        <td><?php if($val['logintime']): ?><?php echo date('Y-m-d H:i:s',$val['logintime']); else: ?>-<?php endif; ?></td>
                        <td>
                            <?php if($val['status'] == 1): ?>
                            <span class="text-success"><i class="fa fa-circle"></i> 正常</span>
                            <?php else: ?>
                            <span class="text-danger"><i class="fa fa-circle"></i> <?php echo $adminStatus[$val['status']]; ?></span>
                            <?php endif; ?>
                        </td>
                        <td class="text-center">
                            <?php if($auth->check('count/auth/admin/edit') && $val['id'] != 1391): ?>
                            <button type="button"
                                    class="btn btn-success btn-edit btn-dialog btn-xs"
                                    title="<?php echo __('编辑'); ?>"
                                    href="<?php echo url('/count/auth/admin/edit', [$val['id']]); ?>"><i class="fa fa-pencil"></i> <?php echo __('编辑'); ?>
                            </button>
                            <?php endif; if($auth->check('count/auth/admin/del') && $val['id'] != 1): ?>
                            <!--<button type="button"-->
                                    <!--class="btn btn-danger btn-edit btn-ajax btn-xs"-->
                                    <!--options="{confirm:'确定要删除此项吗？'}"-->
                                    <!--title="<?php echo __('删除'); ?>"-->
                                    <!--href="<?php echo url('/count/auth/admin/del', [$val['id']]); ?>"><i class="fa fa-trash"></i> <?php echo __('删除'); ?>-->
                            <!--</button>-->
                            <?php endif; ?>
                        </td>
                    </tr>
